...
class MetricPredictor:
    ...
    model_description = "Forecasted value from Neural Prophet model"
    model = None
    predicted_df = None
    metric = None
    ...
    def train(self, metric_data=None, prediction_duration=15):
        ...
        # Don't really need to store the model, as prophet models are not retractable
        ...
        self.model.fit(self.metric.metric_values, freq=prediction_freq)
